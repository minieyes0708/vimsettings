...
flags = [
    ...
    '-x', 'c++',
    '-isystem', r'C:\Program Files (x86)\Windows Kits\10\Include\10.0.18362.0\ucrt',
    '-isystem', r'C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.27.29110\include',
